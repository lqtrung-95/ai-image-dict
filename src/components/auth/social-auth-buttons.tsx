...
import { safeRedirectPath } from '@/lib/auth/ensure-user-profile';
...
export function SocialAuthButtons({ redirectTo = '/' }: SocialAuthButtonsProps) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    const callbackUrl = `${window.location.origin}/auth/callback?redirectTo=${encodeURIComponent(nextPath)}`;
