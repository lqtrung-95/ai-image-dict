      ...
      <div className="mb-6">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1">
            ...
            {course.description && (
              <p className="text-[#e0e2e8]">{course.description}</p>
            )}
      ...
      <div>
        ...
        <div className="space-y-2">
          {words.map((word, index) => (
            <Card
              key={word.id}
              className="p-4 bg-[#1c2024]/50 border-white/10 hover:border-white/10"
            >
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[#bacbbe]">{word.word_pinyin}</span>
                    {word.hsk_level && (
                  ...
                  <p className="text-[#bacbbe]">{word.word_en}</p>
